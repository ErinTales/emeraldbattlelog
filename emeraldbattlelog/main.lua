...
local charmapPath = "C:/Users/Erin/source/repos/emeraldbattlelog/pokemon lua/charmap.txt"
...
callbacks:add("frame", function()
    ...
    if frameCounter % 60 == 0 and #pendingLogs > 0 then
        local logfile = io.open(
            "C:/Users/Erin/source/repos/emeraldbattlelog/pokemon lua/battlelog.txt",
            "a"
        )
